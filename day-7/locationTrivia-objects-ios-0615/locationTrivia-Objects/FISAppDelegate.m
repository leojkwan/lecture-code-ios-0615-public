...
//    NSDictionary *location =  @{@"name": @"Statue of Liberty",
//                                @"longitude": @71.324,
//                                @"latitude": @-31.412};
...
//    NSLog(@"%@",[self createLocationWithName:@"Joe" Latitude:@32 Longitude:@43]);
    ...
    FISTriviaLocation *trivia = [[FISTriviaLocation alloc] init];
    trivia.name = @"Statue of Liberty";
    NSLog(@"%@", trivia.shortName);

//    NSLog(@"%@", [@"hi" arrayOfCharacters]);
