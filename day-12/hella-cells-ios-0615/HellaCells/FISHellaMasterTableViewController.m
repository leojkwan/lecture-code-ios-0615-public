         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"%lu", currentRow + 1];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    NSIndexPath *selectedIndexPath = [self.tableView indexPathForCell:tappedCell];

//    NSIndexPath *selectedIndexPath = self.tableView.indexPathForSelectedRow;
    NSUInteger selectedNumber = selectedIndexPath.row + 1;

    destination.integerToDisplay = selectedNumber;
}
