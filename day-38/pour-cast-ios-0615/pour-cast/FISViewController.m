...
//        FISDailyForecast *firstDay = dailyForecastModels[0];
//        self.day1View.forecast = firstDay;
        ...
        for(NSUInteger i = 0; i < dayViews.count; i++) {
            FISDailyForecastView *dayView = dayViews[i];
            dayView.dailyForecast = dailyForecastModels[i + 1];
        }
