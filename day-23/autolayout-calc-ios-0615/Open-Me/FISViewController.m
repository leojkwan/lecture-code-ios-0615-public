...
//
//    NSArray *hSecondRowConstraints = [NSLayoutConstraint constraintsWithVisualFormat:@"|[fourButton][fiveButton(==fourButton)][sixButton(==fourButton)][multiplyButton(==fourButton)]|" options:0 metrics:nil views:self.viewsDictionary];
//    [self.buttonsContainer addConstraints:hSecondRowConstraints];

    [self addButtonRowConstraintsForViews:@[ self.oneButton,
                                             self.twoButton,
                                             self.threeButton,
                                             self.divideButton ]];

    [self addButtonRowConstraintsForViews:@[ self.fourButton,
                                             self.fiveButton,
                                             self.sixButton,
                                             self.multiplyButton ]];

    [self addButtonRowConstraintsForViews:@[ self.sevenButton,
                                             self.eightButton,
                                             self.nineButton,
                                             self.subtractionButton ]];

    [self addButtonRowConstraintsForViews:@[ self.zeroButton,
                                             self.decimalButton,
                                             self.equalButton,
                                             self.additionButton ]];
...
-(void)addButtonColumnConstraintsForViews:(NSArray *)views
{
    ...
    NSArray *rowConstraints = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|[view1][view2(==view1)][view3(==view1)][view4(==view1)]|"
                                                                      options:0
                                                                      metrics:nil
                                                                        views:localViewDictionary];
